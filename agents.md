...
Примечание:
- базовая ручная перепроверка профилей, hints и сохранение последнего результата проверки уже есть; следующий шаг в этой зоне — делать диагностику еще богаче.
