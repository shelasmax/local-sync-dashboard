...
Примечание:
- базовая ручная перепроверка профилей, hints, сохранение последнего результата проверки и richer hints по типам ошибок уже есть; следующий шаг в этой зоне — углублять диагностику еще дальше.
