...
2. Дальнейшее усиление recovery UX вокруг repeat-from-delta и длинных ночных запусков
...
- основной action UX в интерфейсе уже переведен на icon-buttons с `title`/tooltip и скрытым текстом для доступности; при дальнейших правках не смешивать рядом icon-only и длинные текстовые кнопки без явной причины.
